...
public sealed partial class MultiplayerUI
{
    ...
    private void FirstTimeScreen()
    {
        ...
        DrawText("Username:", 2);
        usernameInput = TextField(CalculateInputLayout(6, 2, 1), usernameInput, 0);
    ...
    private void InGameScreen()
    {
        ...
        DrawText("IP", 2);
        ipInput = TextField(CalculateInputLayout(6, 2, 1), ipInput, 1);

        DrawText("Port", 2);
        portInput = TextField(CalculateInputLayout(6, 2, 1), portInput, 2);
        ...
        DrawText("Port", 2);
        hostPortInput = TextField(CalculateInputLayout(6, 2, 1), hostPortInput, 3);
